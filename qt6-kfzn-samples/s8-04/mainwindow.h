...
private:
    ...
    QFile *file_dev_;
    QDataStream *file_strm_;

    bool iniWrite();        // 初始化文件写操作
    bool iniRead();            // 初始化文件读操作
    void delFileStream();   // 删除QFile, QDataStream对象
...
private slots:
    ...
    void on_btnUtfStrWrite_clicked();

    void on_btnLatinStrWrite_clicked();
    ...
    void on_btnUtfStrRead_clicked();

    void on_btnLatinStrRead_clicked();
